...
import com.portal.jobportal.services.JobPostActivityService;
import com.portal.jobportal.services.JobSeekerApplyService;
import com.portal.jobportal.services.JobSeekerSaveService;
            ...
            if(authentication.getAuthorities().contains(
                ...
                for(JobPostActivity jobActivity: jobPost){
                    ...
                    for(JobSeekerSave jobSeekerSave : jobSeekerSaveList){
                        if(Objects.equals(jobActivity.getJobPostId(),jobSeekerSave.getJob().getPostedById())){
