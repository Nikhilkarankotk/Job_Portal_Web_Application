...
import com.portal.jobportal.model.IRecruiterJobs;
...
public interface JobPostActivityRepository  extends JpaRepository<JobPostActivity,Integer> {
    ...
    @Query(value = " SELECT COUNT(s.user_id) as totalCandidates,j.job_post_id," +
            "j.job_title,l.id as locationId,l.city,l.state,l.country," +
